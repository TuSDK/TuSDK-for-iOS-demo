 ...
 *  图片编辑入口控制器委托
 */
@protocol TuSDKPFEditEntryControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 */
- (void)onTuSDKPFEditEntry:(TuSDKPFEditEntryController *)controller result:(TuResult *)result;
 ...
 */
- (BOOL)onAsyncTuSDKPFEditEntry:(TuSDKPFEditEntryController *)controller result:(TuResult *)result;
@end
 ...
 *  图片编辑入口控制器
 */
@interface TuSDKPFEditEntryController : TuEditEntryControllerBase{
@protected
    // 默认样式视图
