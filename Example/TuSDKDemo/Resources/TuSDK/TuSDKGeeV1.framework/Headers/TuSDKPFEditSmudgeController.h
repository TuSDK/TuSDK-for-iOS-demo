 ...
 *  涂抹编辑控制器委托
 */
@protocol TuSDKPFEditSmudgeControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onTuSDKPFEditSmudge:(TuSDKPFEditSmudgeController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncTuSDKPFEditSmudge:(TuSDKPFEditSmudgeController *)controller result:(TuResult *)result;
@end
 ...
 *  涂抹编辑控制器
 */
@interface TuSDKPFEditSmudgeController : TuEditSmudgeControllerBase<TuSDKPFBrushBarViewDelegate>
{
    // 默认样式视图
