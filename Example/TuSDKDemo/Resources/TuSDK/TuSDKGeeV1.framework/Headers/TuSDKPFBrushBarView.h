 ...
 *  笔刷列表视图
 */
@interface TuSDKPFBrushTableView : UIView<UITableViewDataSource, UITableViewDelegate, TuBrushTableViewInterface>
/**
 ...
 *  @param data    笔刷数据对象
 */
- (void)brushBarView:(TuSDKPFBrushBarView *)view selectBrush:(TuBrush *)data;
...
@interface TuSDKPFBrushBarView : TuBrushBarViewBase<TuBrushTableViewDelegate>
{
    @protected
    // 参数配置视图
    UIView *_configView;
