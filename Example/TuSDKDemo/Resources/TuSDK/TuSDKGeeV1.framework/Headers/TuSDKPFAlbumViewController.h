 ...
 *  系统相册委托
 */
@protocol TuSDKPFAlbumDelegate <TuComponentErrorDelegate>
/**
 *  选中相册组
 *
 ...
 *  @param group 相册组
 */
- (void)onTuSDKPFAlbum:(TuSDKPFAlbumViewController *)controller selectedGroup:(id<TuTSAssetsGroupInterface>)group;
 ...
 *  系统相册控制器
 */
@interface TuSDKPFAlbumViewController : TuAlbumViewControllerBase<TuSDKPFAlbumViewProtocol>{
    @protected
    /**
     *  默认样式视图
     */
