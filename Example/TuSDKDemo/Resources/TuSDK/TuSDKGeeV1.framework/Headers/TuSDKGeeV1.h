...
+ (TuSDKCPAlbumComponent *)albumCommponentWithController:(UIViewController *)controller
                                           callbackBlock:(TuEditComponentBlock)block;
...
/**
 *  获取头像设置组件
 *  @see-https://tutucloud.com/docs/ios/image/api-geev1/Classes/TuSDKCPAvatarComponent.html
 *
 *  @param controller 来源控制器
 *  @param block      组件回调结果
 *
...
/**
 *  获取图片编辑组件
 *  @seehttps://tutucloud.com/docs/ios/image/api-geev1/Classes/TuSDKCPPhotoEditComponent.html
 *
 *  @param controller 来源控制器
 *  @param block      组件回调结果
 *
