 ...
 *  旋转和裁剪视图控制器委托
 */
@protocol TuSDKPFEditTurnAndCutDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 */
- (BOOL)onAsyncTuSDKPFEditTurnAndCut:(TuSDKPFEditTurnAndCutViewController *)controller result:(TuResult *)result;
@end
 ...
 *  旋转和裁剪视图控制器
 */
@interface TuSDKPFEditTurnAndCutViewController : TuEditTurnAndCutViewControllerBase<TuSDKPFNormalFilterGroupDelegate>{
    @protected
    // 默认样式视图
