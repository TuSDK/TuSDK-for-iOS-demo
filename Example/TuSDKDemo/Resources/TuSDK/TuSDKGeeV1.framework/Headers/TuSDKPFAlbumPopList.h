 ...
 *  @param group 相册组
 */
- (void)onTuSDKPFAlbumSelectedWithGroup:(id<TuTSAssetsGroupInterface>)group;
@end

@interface TuSDKPFAlbumPopList : TuTableView<UITableViewDataSource, UITableViewDelegate>
 ...
 *  系统相册列表
 */
@property (nonatomic, strong) NSArray<id<TuTSAssetsGroupInterface>> *groups;
 ...
 *  @param group 相册对象
 */
- (void)selectGroup:(id<TuTSAssetsGroupInterface>)group;
