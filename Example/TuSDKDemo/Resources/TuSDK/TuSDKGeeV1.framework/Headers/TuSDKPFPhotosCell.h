 ...
 *  照片数据
 */
@property (nonatomic, retain) id<TuTSAssetInterface> data;
@end
 ...
 *  @param asset 照片对象
 */
- (void)onTuSDKPFPhotosCellSelectedWithAsset:(id<TuTSAssetInterface>)asset;
@end

/**
 *  相册照片列表行视图
 */
@interface TuSDKPFPhotosCell : TuTableViewCell
/**
 ...
 *  网格视图算法
 */
@property (nonatomic, retain) TuAOCellGridViewAlgorithmic *algorithmic;
 ...
 *  @param data 数据
 */
- (void)setData:(NSArray<TuTSAssetInterface> *)data;
@end
