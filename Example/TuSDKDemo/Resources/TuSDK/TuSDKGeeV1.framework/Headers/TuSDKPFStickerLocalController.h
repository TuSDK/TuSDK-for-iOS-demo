 ...
 *  @param result 处理结果
 */
- (void)onTuSDKPFStickerLocal:(TuSDKPFStickerLocalController *)controller sticker:(TuSticker *)sticker;
@end
 ...
 *  本地贴纸选择控制器
 */
@interface TuSDKPFStickerLocalController : TuStickerLocalControllerBase<TuPagerViewDataSource, TuSDKPFStickerLocalViewProtocol, TuSDKPFStickerOnlineControllerDelegate>{
@protected
    // 默认样式视图
