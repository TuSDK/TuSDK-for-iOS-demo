 ...
 *  多功能图像编辑控制器委托
 */
@protocol TuSDKPFEditMultipleControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 */
- (void)onTuSDKPFEditMultiple:(TuSDKPFEditMultipleController *)controller result:(TuResult *)result;
 ...
 */
- (BOOL)onAsyncTuSDKPFEditMultiple:(TuSDKPFEditMultipleController *)controller result:(TuResult *)result;
@end
 ...
 *  多功能图像编辑控制器
 */
@interface TuSDKPFEditMultipleController : TuEditMultipleControllerBase{
@protected
    // 默认样式视图
