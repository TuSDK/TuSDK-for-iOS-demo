 ...
 *  @param sticker 贴纸对象
 */
- (void)onTuSDKPFStickerLocalViewSelected:(TuSticker *)sticker;
 ...
 *  本地贴纸空视图
 */
@interface TuSDKPFStickerLocalEmptyView : TuEmptyView
{
    /**
     *  信息视图
     */
 ...
 *  本地贴纸选择单元格视图
 */
@interface TuSDKPFStickerLocalGridView : TuStickerLocalGridViewBase
{
    // 图片视图
 ...
 *  本地贴纸选择列表行视图
 */
@interface TuSDKPFStickerLocalCellView : TuTableViewCell
/**
 ...
 *  本地贴纸选择列表视图
 */
@interface TuSDKPFStickerLocalListView : UIView<TuPagerHolderViewProtocol, UITableViewDataSource, UITableViewDelegate>
{
    // 列表视图
