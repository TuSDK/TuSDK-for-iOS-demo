 ...
 *  多功能图像编辑组件选项
 */
@interface TuSDKCPPhotoEditMultipleOptions : TuOptions
/**
 *  多功能图像编辑控制器配置选项
 */
 ...
 *  多功能图像编辑组件
 */
@interface TuSDKCPPhotoEditMultipleComponent : TuPhotoEditMultipleComponentBase<TuSDKPFEditMultipleControllerDelegate,
TuSDKPFEditCuterControllerDelegate, TuSDKPFEditFilterControllerDelegate, TuFilterResultControllerDelegate,
