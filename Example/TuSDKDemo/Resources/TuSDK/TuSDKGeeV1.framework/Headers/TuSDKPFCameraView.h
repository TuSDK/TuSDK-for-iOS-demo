...
// 设置按钮禁用状态
- (void)updateButtonAtIndex:(lsqCameraSettingBtnType)type enable:(BOOL)enable;
@end
...
@interface TuSDKPFCameraView : UIView<TuSDKPFCameraSettingDelegate>{
    ...
    // 聚焦触摸视图
    TuSDKCPFocusTouchView *_focusTouchView;
    // 默认相机控制栏视图
...
// GL视图
@property (nonatomic, readonly) TuCAEAGLView* surfaceView;
// 聚焦触摸视图
@property (nonatomic, readonly) TuSDKCPFocusTouchView* focusTouchView;
// 默认相机控制栏视图
...
// 开启禁用闪光灯按钮
@property (nonatomic) BOOL enableFlashButton;
