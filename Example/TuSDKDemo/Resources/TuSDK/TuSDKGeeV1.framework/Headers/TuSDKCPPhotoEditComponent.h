 ...
 *  图片编辑组件配置
 */
@interface TuSDKCPPhotoEditOptions : TuOptions
/**
 *  图片编辑入口控制器配置选项
 */
 ...
 *  图片编辑组件
 */
@interface TuSDKCPPhotoEditComponent : TuPhotoEditComponentBase<TuSDKPFEditEntryControllerDelegate, TuSDKPFEditCuterControllerDelegate, TuSDKPFEditFilterControllerDelegate, TuSDKPFStickerLocalControllerDelegate>
/**
 *  图片编辑组件配置选项
 */
