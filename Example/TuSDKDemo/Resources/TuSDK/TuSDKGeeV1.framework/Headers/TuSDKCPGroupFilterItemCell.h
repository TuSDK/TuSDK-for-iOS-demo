 ...
 *  滤镜分组元素视图
 */
@interface TuSDKCPGroupFilterItemCell : TuGroupFilterItemCellBase<TuGroupFilterItemCellInterface>{
    @protected
    // 包装视图
    UIView *_wrapView;
    // 图片视图
 ...
 *  滤镜分组视图
 */
@interface TuSDKCPGroupFilterGroupCell : TuGroupFilterGroupCellBase{
    @protected
    // 包装视图
    UIView *_wrapView;
    // 图片视图
