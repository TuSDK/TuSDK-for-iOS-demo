 ...
 *  多功能相册组件配置选项
 */
@interface TuSDKCPAlbumMultipleOptions : TuOptions
/**
 *  系统相册控制器配置选项
 */
 ...
 *  多功能相册组件
 */
@interface TuSDKCPAlbumMultipleComponent : TuAlbumMultipleComponentBase<TuSDKPFAlbumMultipleDelegate, TuSDKPFCameraDelegate>
/**
 *  自定义系统相册组件配置选项
 */
