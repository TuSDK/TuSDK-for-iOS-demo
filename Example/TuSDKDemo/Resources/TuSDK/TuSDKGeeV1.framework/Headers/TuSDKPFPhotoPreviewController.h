 ...
 *  @param assets     相片数组
 */
- (void)onTuSDKPFPhotos:(TuSDKPFPhotoPreviewController *)controller selectedAssets:(NSArray<TuTSAssetInterface> *)assets;
 ...
 *  相册预览控制器
 */
@interface TuSDKPFPhotoPreviewController : TuPhotoPreviewControllerBase<TuSDKPFPhotosGridPreviewProtocol>
{
@protected
/**
 *  默认样式视图
