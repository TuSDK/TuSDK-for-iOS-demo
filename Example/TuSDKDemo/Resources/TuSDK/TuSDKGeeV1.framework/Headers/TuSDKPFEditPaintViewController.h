 ...
 *  @since v3.1.0
 */
@protocol TuSDKPFEditPaintViewControllerDelegate <TuComponentErrorDelegate>
 ...
 *  @param result 处理结果
 */
- (void)onTuSDKPFEditPaint:(TuSDKPFEditPaintViewController *)controller result:(TuResult *)result;
@optional
 ...
 */
- (BOOL)onAsyncTuSDKPFEditPaint:(TuSDKPFEditPaintViewController *)controller result:(TuResult *)result;
@end
 ...
 *  @since v3.1.0
 */
@interface TuSDKPFEditPaintViewController : TuImageResultController<TuSDKPFPaintBarViewDelegate>
{
    // 默认样式视图
