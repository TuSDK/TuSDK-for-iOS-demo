 ...
 *  图片编辑贴纸选择控制器委托
 */
@protocol TuSDKPFEditStickerControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onTuSDKEditSticker:(TuSDKPFEditStickerController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncTuSDKEditSticker:(TuSDKPFEditStickerController *)controller result:(TuResult *)result;
@end
 ...
 *  图片编辑贴纸选择控制器
 */
@interface TuSDKPFEditStickerController : TuEditStickerControllerBase<TuSDKPFStickerBarViewDelegate,
