 ...
 *  图片编辑贴纸选择控制器委托
 */
@protocol TuSDKPFEditTextControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onTuSDKEditText:(TuSDKPFEditTextController *)controller result:(TuResult *)result;
 ...
 */
- (BOOL)onAsyncTuSDKEditText:(TuSDKPFEditTextController *)controller result:(TuResult *)result;
...
@interface TuSDKPFEditTextController : TuEditTextControllerBase{
    // 默认样式视图
