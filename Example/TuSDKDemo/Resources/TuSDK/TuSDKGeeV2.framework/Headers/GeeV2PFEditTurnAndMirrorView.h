 ...
 *  旋转和镜像视图
 */
@interface GeeV2PFEditTurnAndMirrorView : UIView<TuTouchImageViewDelegate>{
@protected
    // 旋转视图控制栏
    GeeV2PFEditTurnAndMirrorBottomView *_bottomBar;
    // 图片编辑视图 (旋转，缩放)
    UIView<TuTouchImageViewInterface> *_editImageView;
}
 ...
 *  图片编辑视图 (旋转，缩放)
 */
@property (nonatomic, readonly) UIView<TuTouchImageViewInterface> *editImageView;
