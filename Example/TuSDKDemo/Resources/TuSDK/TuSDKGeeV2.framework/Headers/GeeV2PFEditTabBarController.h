 ...
 *  @param result 处理结果
 */
- (void)onGeeV2PFEditFragment:(GeeV2PFEditTabBarController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFEditFragment:(GeeV2PFEditTabBarController *)controller result:(TuResult *)result;
@end

@interface GeeV2PFEditTabBarController : TuEditTabBarControllerBase<GeeV2PFEditCuterControllerDelegate, GeeV2PFEditTurnAndMirrorDelegate, GeeV2PFEditWipeAndFilterControllerDelegate, TuFilterResultControllerDelegate>
{
@protected
    // 默认样式视图
