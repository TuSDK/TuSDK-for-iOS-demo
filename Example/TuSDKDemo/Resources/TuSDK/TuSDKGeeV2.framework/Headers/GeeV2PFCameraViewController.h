 ...
 *  默认相机视图控制器委托
 */
@protocol GeeV2PFCameraDelegate <TuComponentErrorDelegate>
/**
 *  获取一个拍摄结果
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFCamera:(GeeV2PFCameraViewController *)controller captureResult:(TuResult *)result;
 ...
 *  默认相机视图控制器
 */
@interface GeeV2PFCameraViewController : TuCameraViewControllerBase<GeeV2PFCameraViewDelegate, GeeV2PFCameraFilterGroupViewDelegate, GeeV2PFCameraPreviewControllerDelegate>{
@protected
    // 默认样式视图
