 ...
 *  滤镜分组元素视图
 */
@interface GeeV2CPGroupFilterItemCell : TuGroupFilterItemCellBase<TuGroupFilterItemCellInterface>
{
@protected
    // 包装视图
    UIView *_wrapView;
 ...
 *  滤镜分组视图
 */
@interface GeeV2CPFilterSectionView : TuGroupFilterGroupCellBase{
@protected
    // 包装视图
    UIView *_wrapView;
    // 图片视图
