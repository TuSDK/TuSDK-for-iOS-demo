 ...
 *  大光圈控制器
 */
@interface GeeV2PFEditApertureController : TuEditApertureControllerBase<GeeV2PFEditTabBarSubControllerInterface>
 ...
 *  大光圈控制器配置选项
 */
@interface GeeV2PFEditApertureOptions : TuImageResultOptions
/**
