 ...
 *  图片编辑裁切旋转控制器委托
 */
@protocol GeeV2PFEditCuterControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onGeeV2PFEditCuter:(GeeV2PFEditCuterController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFEditCuter:(GeeV2PFEditCuterController *)controller result:(TuResult *)result;
@end
 ...
 *  图片编辑裁切旋转控制器
 */
@interface GeeV2PFEditCuterController : TuEditCuterControllerBase<GeeV2PFEditTabBarSubControllerInterface>{
@protected
    // 默认样式视图
