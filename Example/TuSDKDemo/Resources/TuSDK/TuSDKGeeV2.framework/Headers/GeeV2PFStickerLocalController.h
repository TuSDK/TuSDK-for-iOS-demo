 ...
 *  @param result 处理结果
 */
- (void)onGeeV2PFStickerLocal:(GeeV2PFStickerLocalController *)controller sticker:(TuSticker *)sticker stickerGroup:(TuStickerGroup *)stickerGroup;
@end
 ...
 *  本地贴纸选择控制器
 */
@interface GeeV2PFStickerLocalController : TuStickerLocalControllerBase<TuPagerViewDataSource, GeeV2PFStickerLocalViewProtocol, GeeV2PFStickerOnlineControllerDelegate>{
@protected
    // 默认样式视图
