 ...
 *  单元格视图
 */
@interface GeeV2PFEditImageSelectTableViewCell : TuTableViewCell
 ...
 *  单元格数据
 */
@property (nonatomic, retain) TuResult *mode;
 ...
 *  列表资源数组
 */
@property (nonatomic, retain) NSArray<TuResult *> *modeList;
