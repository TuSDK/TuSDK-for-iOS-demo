 ...
 *  @param assets     相片数组
 */
- (void)onGeeV2PFPhotos:(GeeV2PFPhotoPreviewController *)controller selectedAssets:(NSArray<TuTSAssetInterface> *)assets;
 ...
 *  相册预览控制器
 */
@interface GeeV2PFPhotoPreviewController : TuPhotoPreviewControllerBase<GeeV2PFPhotoGridPreviewProtocol>{
@protected
    /**
     *  默认样式视图
     */
