 ...
 *  贴纸列表行视图
 */
@interface GeeV2PFStickerTableCell : TuTableViewCell{
@protected
    // 单元格视图
 ...
 *  @param data    贴纸数据对象
 */
- (void)stickerBarView:(GeeV2PFStickerBarView *)view selectSticker:(TuSticker *)data;
 ...
 *  @param cate 贴纸分类
 */
- (void)stickerBarView:(GeeV2PFStickerBarView *)view emptyWithCategory:(TuStickerCategory *)cate;
@end

/**
 *  贴纸栏视图
 */
@interface GeeV2PFStickerBarView : TuStickerBarViewBase<GeeV2PFStickerTableViewDelegate>{
@protected
    // 贴纸列表视图
