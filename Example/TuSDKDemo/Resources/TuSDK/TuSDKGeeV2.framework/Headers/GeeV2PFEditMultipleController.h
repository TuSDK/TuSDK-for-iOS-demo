 ...
 *  多功能图像编辑控制器委托
 */
@protocol GeeV2PFEditMultipleControllerDelegate <TuComponentErrorDelegate>
 ...
 */
- (void)onGeeV2PFEditMultiple:(GeeV2PFEditMultipleController *)controller result:(NSArray<TuResult *> *)resultArray;
 ...
 *  多功能图像编辑控制器
 */
@interface GeeV2PFEditMultipleController : TuEditMultipleControllerBase{
    @protected
    // 默认样式视图
 ...
 *  输入资源对象列表
 */
@property (nonatomic, retain) NSArray<TuResult *> *inputResources;
