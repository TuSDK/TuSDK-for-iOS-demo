 ...
 *  图片编辑贴纸选择控制器委托
 */
@protocol GeeV2PFEditStickerControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onGeeV2EditSticker:(GeeV2PFEditStickerController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2EditSticker:(GeeV2PFEditStickerController *)controller result:(TuResult *)result;
@end
 ...
 *  图片编辑贴纸选择控制器
 */
@interface GeeV2PFEditStickerController : TuEditStickerControllerBase<GeeV2PFStickerBarViewDelegate,
...
/**
 * 贴纸分类列表 (默认: [TuStickerLocalPackage package])
 */
