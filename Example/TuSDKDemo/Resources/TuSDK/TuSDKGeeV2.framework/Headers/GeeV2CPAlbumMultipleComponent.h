 ...
 *  多功能相册组件配置选项
 */
@interface GeeV2CPAlbumMultipleOptions : TuOptions
/**
 *  系统相册控制器配置选项
 */
 ...
 *  多功能相册组件
 */
@interface GeeV2CPAlbumMultipleComponent : TuAlbumMultipleComponentBase<GeeV2PFAlbumMultipleDelegate>
/**
 *  自定义系统相册组件配置选项
 */
 ...
 */
+ (instancetype)initWithSourceController:(UIViewController *)controller callbackBlock:(TuEditComponentBlock)callbackBlock openCameraCallback:(GeeV2CPAlbumMultipleOpenCameraBlock)openCameraCallback;
