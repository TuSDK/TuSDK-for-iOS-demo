 ...
 *  旋转视图控制器委托
 */
@protocol GeeV2PFEditTurnAndMirrorDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 */
- (void)onGeeV2PFEditTurnAndMirror:(GeeV2PFEditTurnAndMirrorViewController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFEditTurnAndMirror:(GeeV2PFEditTurnAndMirrorViewController *)controller result:(TuResult *)result;
@end
 ...
 *  旋转和镜像视图控制器
 */
@interface GeeV2PFEditTurnAndMirrorViewController : TuEditTurnAndCutViewControllerBase<GeeV2PFEditTabBarSubControllerInterface>{
@protected
    // 默认样式视图
