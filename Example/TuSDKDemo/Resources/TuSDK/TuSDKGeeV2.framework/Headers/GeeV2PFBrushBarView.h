 ...
 *  笔刷列表视图
 */
@interface GeeV2PFBrushTableView : UIView<UITableViewDataSource, UITableViewDelegate, TuBrushTableViewInterface>
/**
 ...
 *  @param data    笔刷数据对象
 */
- (void)brushBarView:(GeeV2PFBrushBarView *)view selectBrush:(TuBrush *)data;

@end

#pragma mark - GeeV2PFBrushBarView

@interface GeeV2PFBrushBarView : TuBrushBarViewBase<TuBrushTableViewDelegate>
{
@protected
    // 笔刷列表视图
