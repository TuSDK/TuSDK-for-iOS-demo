 ...
 *  @param result 处理结果
 */
- (void)onGeeV2PFCameraPreview:(GeeV2PFCameraPreviewController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFCameraPreview:(GeeV2PFCameraPreviewController *)controller result:(TuResult *)result;
 ...
 *  相机预览视图控制器
 */
@interface GeeV2PFCameraPreviewController : TuCameraPreviewControllerBase
/**
 *  拍照结果
 */
@property(nonatomic, retain) TuResult *result;
