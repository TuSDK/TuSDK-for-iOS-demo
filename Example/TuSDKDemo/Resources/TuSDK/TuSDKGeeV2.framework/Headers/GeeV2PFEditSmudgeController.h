 ...
 *  涂抹编辑控制器委托
 */
@protocol GeeV2PFEditSmudgeControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onGeeV2PFEditSmudge:(GeeV2PFEditSmudgeController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFEditSmudge:(GeeV2PFEditSmudgeController *)controller result:(TuResult *)result;
@end
 ...
 *  涂抹编辑控制器
 */
@interface GeeV2PFEditSmudgeController : TuEditSmudgeControllerBase<GeeV2PFBrushBarViewDelegate>
{
    // 默认样式视图
