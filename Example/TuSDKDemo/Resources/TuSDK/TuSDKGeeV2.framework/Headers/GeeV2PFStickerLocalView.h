 ...
 *  @param sticker 贴纸对象
 */
- (void)onTuSDKPFStickerLocalViewSelected:(TuSticker *)sticker stickerGroup:(TuStickerGroup *)stickerGroup;
 ...
 *  本地贴纸空视图
 */
@interface GeeV2PFStickerLocalEmptyView : TuEmptyView
{
    /**
     *  信息视图
     */
 ...
 *  贴纸包
 */
@property (nonatomic, retain) TuStickerGroup *group;
 ...
 *  本地贴纸选择单元格视图
 */
@interface GeeV2PFStickerLocalGridView : TuStickerLocalGridViewBase
{
    // 图片视图
 ...
 *  本地贴纸选择列表行视图
 */
@interface GeeV2PFStickerLocalCellView : TuTableViewCell
/**
 ...
 *  当前贴纸组
 */
@property (nonatomic, retain) TuStickerGroup *stickerGroup;
 ...
 *  本地贴纸选择列表视图
 */
@interface GeeV2PFStickerLocalListView : UIView<TuPagerHolderViewProtocol, UITableViewDataSource, UITableViewDelegate>
{
    // 列表视图
 ...
 *  输入的数据
 */
@property (nonatomic, retain) TuStickerCategory *data;
/**
 *  相册照片列表行视图委托
 */
@property (nonatomic, assign) id<GeeV2PFStickerLocalViewProtocol> gridProtocol;
 ...
 *  横向分页视图
 */
@property (nonatomic, readonly) TuPagerView *pagerView;
