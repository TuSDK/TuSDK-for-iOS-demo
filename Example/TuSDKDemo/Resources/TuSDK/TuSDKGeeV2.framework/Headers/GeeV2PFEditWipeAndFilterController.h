 ...
 *  滤镜涂抹控制器委托
 */
@protocol GeeV2PFEditWipeAndFilterControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onGeeV2PFEditWipeAndFilter:(GeeV2PFEditWipeAndFilterController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFEditWipeAndFilter:(GeeV2PFEditWipeAndFilterController *)controller result:(TuResult *)result;
@end
 ...
 *  滤镜涂抹控制器
 */
@interface GeeV2PFEditWipeAndFilterController : TuEditWipeAndFilterControllerBase<GeeV2PFEditTabBarSubControllerInterface,GeeV2PFEditWipeAndFilterConfigBarDelegate>
{
    // 默认样式视图
