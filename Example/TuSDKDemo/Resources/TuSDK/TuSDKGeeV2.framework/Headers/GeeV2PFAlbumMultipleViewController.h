 ...
 *  系统相册委托
 */
@protocol GeeV2PFAlbumMultipleDelegate <TuComponentErrorDelegate>
 ...
 *  @param group      相册组
 */
- (void)onGeeV2PFAlbum:(GeeV2PFAlbumMultipleViewController *)controller selectedGroup:(id<TuTSAssetsGroupInterface>)group;
 ...
 *  @param assets     相片数组
 */
- (void)onGeeV2PFPhotos:(GeeV2PFAlbumMultipleViewController *)controller selectedAssets:(NSArray<TuTSAssetInterface> *)assets;
 ...
 *  包含相机的系统相册控制器
 */
@interface GeeV2PFAlbumMultipleViewController : TuAlbumMultipleViewControllerBase<GeeV2PFAlbumMultipleViewProtocol>{
@protected
    /**
     *  默认样式视图
     */
