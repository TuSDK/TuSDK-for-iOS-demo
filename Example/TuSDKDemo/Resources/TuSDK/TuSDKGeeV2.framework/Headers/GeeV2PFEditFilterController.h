 ...
 *  图片编辑滤镜控制器委托
 */
@protocol GeeV2PFEditFilterControllerDelegate <TuComponentErrorDelegate>
/**
 *  图片编辑完成
 *
 ...
 *  @param result 处理结果
 */
- (void)onGeeV2PFEditFilter:(GeeV2PFEditFilterController *)controller result:(TuResult *)result;
@optional
/**
 *  图片编辑完成  (异步方法)
 *
 ...
 */
- (BOOL)onAsyncGeeV2PFEditFilter:(GeeV2PFEditFilterController *)controller result:(TuResult *)result;
@end
 ...
 *  图片编辑滤镜控制器
 */
@interface GeeV2PFEditFilterController : TuEditFilterControllerBase<GeeV2PFEditFilterGroupDelegate>{
@protected
    // 默认样式视图
