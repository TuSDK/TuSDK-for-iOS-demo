 ...
 */
typedef void (^GeeV2CPComponentBlock)(NSArray<TuResult *>*outputResults, NSError *error, UIViewController *controller);

#pragma mark - GeeV2CPPhotoEditMultipleOptions
/**
 *  多功能图像编辑组件选项
 */
@interface GeeV2CPPhotoEditMultipleOptions : TuOptions
/**
 *  多功能图像编辑控制器配置选项
 */
 ...
 *  @param controller  最后执行的控制器
 */
- (void)notifyResult:(NSArray<TuResult *> *)resultArray
               error:(NSError *)error
