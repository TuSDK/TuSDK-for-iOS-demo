//
//  TuAlbumMultipleViewControllerBase.h
//  TuSDK
//
...
@interface TuAlbumMultipleViewControllerBase : TuComponentsViewController
 ...
 *  @param group 相册组
 */
- (void)notifySelectedGroup:(id<TuTSAssetsGroupInterface>)group;
