...
@protocol TuPaintDrawViewInterface <NSObject>
 ...
 *  @since v3.1.0
 */
@protocol TuPaintDrawViewDelegate <NSObject>
 ...
 *  @since v3.1.0
 */
@interface TuPaintDrawViewBase : UIView <TuPaintDrawViewInterface>

@property (nonatomic, weak) id<TuPaintDrawViewDelegate> delegate;
...
/**
 ...
 @since v3.1.0
 */
@interface TuPaintDrawDisplayView : UIView <TuPaintDrawViewInterface>
