 ...
 *  @param action 提示信息动作
 */
typedef void(^TuAlertActionHandler)(TuAlertAction *action);
/**
 *  提示信息动作
 */
@interface TuAlertAction : NSObject
/**
 *  提示信息动作 (默认)
 *
 *  @param title   标题
...
#pragma mark - TuAlertView
/**
 *  提示信息视图
 */
@interface TuAlertView : NSObject
 ...
 *  @param action 提示信息动作
 */
- (void)addAction:(TuAlertAction *)action;
 ...
 *  提示信息动作列表
 */
@property (nonatomic, readonly) NSArray<TuAlertAction *> *actions;
/**
 *  标题
 */
