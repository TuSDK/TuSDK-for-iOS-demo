...
@protocol TuAnimationImage <NSObject>
@required
/**
 *  总帧数
 */
...
#pragma mark - TuGifImage


/**
 GifImage对象
 */
@interface TuGifImage : TuImage <TuAnimationImage>
 ...
 *  @return GifImage对象
 */
+ (TuGifImage *)imageNamed:(NSString *)name;
 ...
 *  @return GifImage对象
 */
+ (TuGifImage *)imageWithContentsOfFile:(NSString *)path;
 ...
 */
+ (TuGifImage *)imageWithData:(NSData *)data;
