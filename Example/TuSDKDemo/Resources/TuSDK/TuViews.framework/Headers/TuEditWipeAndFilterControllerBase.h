//
//  TuEditWipeAndFilterControllerBase.h
//  TuSDK
//
...
#import "TuFilterSmudgeImageViewWrap.h"

/**
 *  滤镜涂抹控制器基类
 */
@interface TuEditWipeAndFilterControllerBase : TuImageResultController <TuSmudgeImageViewDelegate>

/**
 *  涂抹画布
 */
@property (nonatomic, readonly) UIView<TuSmudgeImageViewInterface> *smudgeView;
