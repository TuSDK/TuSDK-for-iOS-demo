...
#import "TuGroupFilterBarBase.h"
#import "TuSubTitlesView.h"

/**
 *  滤镜分组视图基类
 */
@interface TuGroupFilterBaseView : UIView<TuGroupFilterBarDelegate>
{
    @protected
    // 是否显示活动状态
...
/**
 *  滤镜列表行视图类 (默认:TuSDKCPGroupFilterItemCell, 需要继承 UITableViewCell<TuGroupFilterItemCellInterface>)
 */
 ...
 *  滤镜组选择栏
 */
@property (nonatomic, readonly) UIView<TuGroupFilterBarInterface> *filterBar;

/**
 *  滤镜标题视图
 */
@property (nonatomic, readonly) UIView<TuSubtitlesViewInterface> *titleView;
 ...
 *  @return BOOL  是否通知
 */
- (BOOL)notifyTitleWithCell:(UITableViewCell<TuGroupFilterItemCellInterface> *)cell
 ...
 *  @param mode 滤镜分组元素
 */
- (void)notifyTitleWithMode:(TuGroupFilterItem *)mode;
