 ...
 *  贴纸栏视图基础类
 */
@interface TuStickerBarViewBase : UIView
/**
 *  初始化视图
 */
- (void)lsqInitView;
 ...
 *  @return 分类按钮
 */
- (UIButton *)buildButtonWithCategory:(TuStickerCategory *)cate left:(CGFloat)left width:(CGFloat)width index:(NSUInteger)index;
 ...
 *  @return 当前分类对象
 */
- (TuStickerCategory *)currentCategory;
