 ...
 *  涂抹编辑控制器基础类
 */
@interface TuEditSmudgeControllerBase : TuImageResultController <TuSmudgeImageViewDelegate>

/**
 *  当前所使用的笔刷
 */
@property (nonatomic, retain) TuBrush *brush;
