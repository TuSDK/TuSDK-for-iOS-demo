...
#import "TuImageDecoder.h"

@interface TuGifDecoder : TuImageDecoder
 ...
 *
 *  @return TuImageFrame 对象
 */
- (TuImageFrame *)frameAtIndex:(NSUInteger)index shouldDecodeData:(BOOL)shouldDecodeData;
