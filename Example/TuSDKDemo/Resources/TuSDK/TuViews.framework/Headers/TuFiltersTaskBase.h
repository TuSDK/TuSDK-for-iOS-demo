...
#import "TuFilterImageWare.h"

#pragma mark - TuFiltersTaskInterface
/**
 *  滤镜任务接口
 */
@protocol TuFiltersTaskInterface <NSObject>
/**
 *  输入滤镜名称
 */
...
#pragma mark - TuFiltersTaskBase
/**
 *  滤镜任务基类
 */
@interface TuFiltersTaskBase : NSObject<TuFiltersTaskInterface>
/**
 *  输入图片
 */
@property (nonatomic, retain) UIImage *inputImage;
