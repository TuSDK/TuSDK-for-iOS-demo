...
namespace tutu
{
    ...
    public:
        ...
        static std::shared_ptr<SelesParams> toCParams(SelesParameters *nParams); // 参数互转
        static SelesParameters * toNParams(std::shared_ptr<SelesParams> cParams, FilterModel model, NSString * code); // 参数互转
    public:
