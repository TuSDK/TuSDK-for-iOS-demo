...
#pragma mark - TuTSALAsset
/**
 *  媒体资源对象
 */
@interface TuTSALAsset : NSObject<TuTSAssetInterface>
/**
 *  初始化媒体资源对象
 *
 *  @param asset ALAsset
...
#pragma mark - TuTSALAssetsGroup
/**
 *  媒体资源组对象
 */
@interface TuTSALAssetsGroup : NSObject<TuTSAssetsGroupInterface>
/**
 *  初始化媒体资源组对象
 *
