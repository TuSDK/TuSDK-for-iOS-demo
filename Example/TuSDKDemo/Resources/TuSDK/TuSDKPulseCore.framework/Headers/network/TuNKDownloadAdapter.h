 ...
 *  资源下载适配器
 */
@interface TuNKDownloadAdapter : TuImageViewTask
{
    @protected
    /**已下载文件列表*/
...
/**下载状态委托*/
@property (nonatomic, weak) id<TuDownloadMangerDelegate> downloadDelegate;
 ...
 * @return BOOL 是否已加载
 */
- (BOOL)appenDownloaded:(TuNKDownloadItem *)item;
