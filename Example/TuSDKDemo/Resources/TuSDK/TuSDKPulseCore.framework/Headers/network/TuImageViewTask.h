...
#pragma mark - TuImageViewTaskWare
/**
 *  图片视图任务包装
 */
@interface TuImageViewTaskWare : NSObject
/**
 *  图片视图
 */
...
#pragma mark - TuImageViewTask
/**
 *  图片视图任务
 */
@interface TuImageViewTask : NSObject
/**
 *  重置任务列表
 */
- (void)resetQueues;
 ...
 *  @return 图片
 */
- (UIImage *)asyncTaskLoadImageWithWare:(TuImageViewTaskWare *)ware;
 ...
 *  @param ware 图片视图任务包装
 */
- (void)loadImageWithWare:(TuImageViewTaskWare *)ware;
@end
