...
extern NSString * const lsqPulseFilterTextures;

/** 默认UI资源包 (TuSDK.bundle/ui_default) */
extern NSString * const lsqPulseSdkUIDefault;

/** SDK其他资源包 (TuSDK.bundle/others) */
extern NSString * const lsqPulseSdkOthers;

/** SDK本地气泡文字资源包 (TuSDK.bundle/others) */
extern NSString * const lsqPulseLocalBubbles;

/** SDK本地贴纸包 (TuSDK.bundle/stickers) */
extern NSString * const lsqPulseLocalStickers;

/** SDK本地模型 (TuSDK.bundle/model) */
extern NSString * const lsqPulseLocalModels;

/** 相机聚焦音效 (camera_focus_beep.mp3) */
extern NSString * const lsqPulseCameraFocusBeepAudio;

/** 内部滤镜配置 (lsq_internal_filters.filter) */
extern NSString * const lsqPulseInternalFiltersConfig;

/** SDK资源包帮助类 */
@interface TuTSBundle : NSObject
 ...
 *  @param file 文件名称
 *
 *  @return SDK资源包气泡文字文件路径
 */
+ (NSString *)sdkBundleBubble:(NSString *)file;
