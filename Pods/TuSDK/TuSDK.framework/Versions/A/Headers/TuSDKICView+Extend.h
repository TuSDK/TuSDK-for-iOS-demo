 ...
 */
+ (void)showMsg:(NSString *)msg cancelTitle:(NSString *)cancelTitle;
 ...
 *  @param title       标题
 */
+ (void)showMsg:(NSString *)msg cancelTitle:(NSString *)cancelTitle title:(NSString *)title;
@end
