//
//  TuSDKSkinTwiceMixedSigmaFilter.h
//  TuSDK
//
...
/**
 *  基于二次多项式混合模型的肤色检测 + 双边滤波 + Sigma
 */
@interface TuSDKSkinTwiceMixedSigmaFilter : GPUImageTwoPassTextureSamplingFilter<TuSDKFilterParameterProtocol>
/**
 *  模糊范围 (从0.0开始，数值越大越模糊)
 */
