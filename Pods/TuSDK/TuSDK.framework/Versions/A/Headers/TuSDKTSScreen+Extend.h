 ...
 *  最小视图自动高度
 *
 *  @return 最小视图自动高度 (小于IOS7时去除状态栏，导航栏，Tab栏高度高度，大于等于IOS7时为全屏高度)
 */
 ...
 *  中等视图自动高度
 *
 *  @return 中等视图自动高度 (小于IOS7时去除状态栏，导航栏高度，大于等于IOS7时为全屏高度)
 */
 ...
 *  排除状态栏自动高度
 *
 *  @return 排除状态栏自动高度 (小于IOS7时去除状态栏高度，大于等于IOS7时为全屏高度)
 */
 ...
 *  全屏视图时Y坐标
 *
 *  @return 全屏视图时Y坐标 (大于等于IOS7时返回状态栏高度, 否则返回0)
 */
 ...
 *  全屏视图时Y坐标
 *
 *  @return @return 全屏视图时Y坐标 (大于等于IOS7时返回状态栏和导航栏高度, 否则返回0)
 */
