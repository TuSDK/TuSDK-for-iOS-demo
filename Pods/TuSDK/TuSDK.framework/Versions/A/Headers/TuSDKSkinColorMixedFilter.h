 ...
 *  混合肤色识别 + 双边滤波
 */
@interface TuSDKSkinColorMixedFilter : GPUImageTwoPassTextureSamplingFilter<TuSDKFilterParameterProtocol>
/**
 *  模糊范围 (从0.0开始，数值越大越模糊)
 */
...
/**
 *  肤色矩阵检测阈值 (从0.0开始，数值越小检测面越大)
 */
@property (nonatomic) CGFloat skinColorThresholdQuadraticMixture;
