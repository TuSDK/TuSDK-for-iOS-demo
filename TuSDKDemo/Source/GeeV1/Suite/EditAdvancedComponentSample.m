                                ...
                                result:(TuSDKResult *)result;
{
    ...
    // 组件选项配置
    // @see-https://tutucloud.com/docs/ios/image/api-geev1/Classes/TuSDKCPPhotoEditComponent.html
    _photoEditComponent =
    ...
    // @see-https://tutucloud.com/docs/ios/image/api-geev1/Classes/TuSDKCPPhotoEditOptions.html
    // _photoEditComponent.options
    
    //    // 图片编辑入口控制器配置选项
    // @see-https://tutucloud.com/docs/ios/image/api-geev1/Classes/TuSDKPFEditEntryOptions.html
    ...
    //    // 本地贴纸选择控制器配置选项
    // @see-https://tutucloud.com/docs/ios/image/api-geev1/Classes/TuSDKPFStickerLocalOptions.html
