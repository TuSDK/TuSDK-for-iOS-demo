...
#pragma mark - ExtendEditTurnAndCutView
/**
 *  自定义旋转和裁剪视图
 */
...
#pragma mark - ExtendEditAndCutComponent
/**
 *  图片编辑组件范例 (对现有组件进行扩展 - 修改界面)
 */
@interface ExtendEditAndCutComponent()<TuSDKPFEditTurnAndCutDelegate>

@end

@implementation ExtendEditAndCutComponent
- (instancetype)init;
{
    self = [super initWithGroupId:3 title:NSLocalizedString(@"extend_EditComponent", @"图片编辑组件")];
    return self;
}
